...
export const SCHOOL_CARDS: Card[] = [
  ...
  { id: 's3', type: '不開心', cn: '找不到我的橡皮擦...', icon: 'Eraser' },
  { id: 's4', type: '不開心', cn: '同學弄倒我的水壺，濕濕的...', icon: 'Droplets' },
  { id: 's5', type: '不開心', cn: '好朋友今天不想跟我玩...', icon: 'UserX' },
  { id: 's6', type: '不開心', cn: '上台說話的時候忘記要說什麼...', icon: 'MicOff' },
  { id: 's7', type: '開心', cn: '今天午餐有我最喜歡的雞塊！', icon: 'Utensils' },
  { id: 's8', type: '開心', cn: '體育課賽跑拿到第一名！', icon: 'Rocket' },
  { id: 's9', type: '不開心', cn: '這題數學好難，我算不出來...', icon: 'ZapOff' },
  { id: 's10', type: '不開心', cn: '排隊的時候有人插隊！', icon: 'AlertTriangle' },
  { id: 's11', type: '不開心', cn: '畫畫課的時候彩色筆沒水了...', icon: 'PenTool' },
  { id: 's12', type: '開心', cn: '幫老師拿東西被誇獎了。', icon: 'CheckCircle2' },
  { id: 's13', type: '開心', cn: '自然課觀察豆子發芽了！', icon: 'Cloud' },
  { id: 's14', type: '不開心', cn: '我的彩色筆被同學用斷了...', icon: 'HeartCrack' },
...
export const HOME_CARDS: Card[] = [
  ...
  { id: 'h3', type: '不開心', cn: '弟弟搶我的玩具還打人！', icon: 'Hand' },
  { id: 'h4', type: '不開心', cn: '媽媽說不能看電視了...', icon: 'Tv' },
  { id: 'h5', type: '不開心', cn: '打破杯子了，怕被罵...', icon: 'GlassWater' },
  { id: 'h6', type: '開心', cn: '今天可以穿我最喜歡的衣服！', icon: 'Heart' },
  { id: 'h7', type: '開心', cn: '洗了一個香噴噴的熱水澡。', icon: 'Droplets' },
  { id: 'h8', type: '不開心', cn: '積木城堡被我不小心撞倒了...', icon: 'Zap' },
  { id: 'h9', type: '不開心', cn: '天黑了，覺得房間裡有怪獸...', icon: 'CloudLightning' },
  { id: 'h10', type: '不開心', cn: '我想吃糖果，但爸爸說不行...', icon: 'Frown' },
  { id: 'h11', type: '開心', cn: '跟爸爸一起去公園騎腳踏車。', icon: 'Activity' },
  { id: 'h12', type: '開心', cn: '拼圖終於拼完了，好有成就感！', icon: 'Trophy' },
  { id: 'h13', type: '不開心', cn: '最喜歡的小被被在洗澡不能抱...', icon: 'Cloud' },
...
export const PLAYGROUND_CARDS: Card[] = [
  ...
  // 不開心 (10張) - 比例 1:2
  { id: 'p6', type: '不開心', cn: '跑步的時候不小心跌倒，膝蓋痛痛...', icon: 'AlertTriangle' },
  { id: 'p7', type: '不開心', cn: '想玩鞦韆可是排隊排好久...', icon: 'History' },
  { id: 'p8', type: '不開心', cn: '踢球的時候球被踢到樹上拿不下來。', icon: 'ZapOff' },
  { id: 'p9', type: '不開心', cn: '有人在玩的時候不小心撞到我。', icon: 'Hand' },
  { id: 'p10', type: '不開心', cn: '我不小心把沙子弄到別人的眼睛裡，好擔心。', icon: 'HelpCircle' },
  { id: 'p11', type: '不開心', cn: '玩遊戲輸了，覺得好不甘心。', icon: 'Frown' },
  { id: 'p12', type: '不開心', cn: '大太陽下排隊升旗，我覺得頭好暈。', icon: 'Flame' },
  { id: 'p13', type: '不開心', cn: '我想跟大哥哥玩，但他們說我太小了。', icon: 'UserX' },
  { id: 'p14', type: '不開心', cn: '我的新鞋子在草地上踩到泥巴了。', icon: 'Droplets' },
  { id: 'p15', type: '不開心', cn: '體育老師的哨音太大聲，嚇了我一跳。', icon: 'Zap' },
];

export const BOSS_CARDS: Card[] = [
  { id: 'b1', type: '不開心', isBoss: true, cn: '打雷了！好大聲好可怕！', icon: 'CloudLightning' },
  { id: 'b2', type: '不開心', isBoss: true, cn: '跟最好的朋友吵架，他不理我了！', icon: 'HeartCrack' },
  { id: 'b3', type: '不開心', isBoss: true, cn: '最重要的寶貝弄丟了，找不到了！', icon: 'Trash2' },
];
